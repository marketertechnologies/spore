...
# ./disk-config.nix. Edit this file once the box is provisioned and
# `nixos-generate-config` has run against the real disk controller, if
# the generated profile differs.
